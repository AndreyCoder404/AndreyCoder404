[![Andrey's GitHub Banner](./assets/banner.png)](https://github.com/AndreyCoder404)
## Мои навыки 
...
<p>Я GO-разработчик, увлеченный созданием полезного приложения для самосовершенствования и здорового образа жизни. 💻

🚀 Мой проект:

[HealthyLifeBot](https://github.com/AndreyCoder404/healthylifebot): приложение Telegram с открытым исходным кодом для здорового образа жизни, в котором я разрабатываю персонализированные рецепты, тренировки и подкасты с использованием GO, Python, API Telegram Bot. Присоединяйтесь к проекту! GitHub https://github.com/AndreyCoder404/healthylifebot


## Цитата часа

<p>За каждой прекрасной вещью есть какая -то боль.</p>
<p>Боб Дилан</p>
